...
import EVENT_DATA_TYPE_DESCRIPTIONS from '@archisinal/contracts/typechain-generated/event-data/collection_fabric.json';
import * as ReturnTypes from '@archisinal/contracts/typechain-generated/event-types/collection_fabric';
import prisma from '@archisinal/db';
import chalk from 'chalk';
import { EventListeners } from '../../events';
import CollectionFabricABI from '@archisinal/contracts/artifacts/collection_fabric.json';
