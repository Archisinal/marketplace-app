...
const main = async () => {
    ...
    indexer.addEventHandlers(
        new ArchNftListener("5HcWLmJifVTs6kvCtxZYfZZn11cb9uDn4LFc1NFydrGrPEUf", ArchNFTAbi),
        new UserListener("5GesXdqd2ELFHJY8q5mAqk6fvFhH38T1tUTi7GX7z4HLRvAd", UserAbi),
        new CreatorListener("5DFLhtsdt92VtqfgVHFD19zoyqWqPWNvPMqZgcbb9Lyhnabr", CreatorAbi),
        new MarketplaceListener("5H7LNHfWseUYQZSwY65eTwbKrHSgC7y5FB6jrqQ1kiArfNTj", MarketplaceAbi),
        new AccountManagerListener("5CUHjCZNK5YhXqjdsDWNg19q8rtDqj98qAJfXDLZQ6DfUxf1", AccountManagerAbi)
    )
