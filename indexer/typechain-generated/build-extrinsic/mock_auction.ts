...
export default class Methods {
	...
	*/
	"setTimestamp" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "setTimestamp", [timestamp], __options);
	}
	...
	*/
	"addTimestamp" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "addTimestamp", [delta], __options);
	}
