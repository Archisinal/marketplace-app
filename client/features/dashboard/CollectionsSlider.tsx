...
const CardSkeleton = ({ className }: { className?: string }) => {
  return (
    ...
    >
      <div className="sm:w-80 md:w-72 h-48 md:h-56 lg:h-72 translate-y-2.5 bg-davys-gray rounded-2xl"></div>
      <div className="border dark:border-dark-gray rounded-b-20 pt-4">
        <div className="px-5 flex flex-col gap-2">
          <p className="text-xl font-extrabold truncate h-7 w-60 lg:w-64 bg-davys-gray rounded"></p>
          <p className="text-txt-gray truncate h-5 w-60 lg:w-64 bg-davys-gray rounded"></p>
        </div>
        <div className=" px-5 mt-4 mb-4">
          <p className="border-t dark:border-dark-gray"></p>
          <div className="flex mt-4 items-center">
            <div className="mr-2.5 ">
              <div className="h-9 w-9 sm:h-12 sm:w-12 bg-davys-gray rounded-xl"></div>
              {/* <ImageComponent width={46} height={46} src={owner.imgSrc} /> */}
            </div>
            <div className="flex justify-between w-full">
              <div>
                <p className="text-txt-gray ">By owner</p>
                <p className="text-lg font-semibold h-4 w-20 bg-davys-gray rounded"></p>
              </div>
              <div>
                <p className="text-txt-gray text-end">Price</p>
                <p className="text-lg flex gap-1 font-semibold h-5 w-16 bg-davys-gray rounded">
...
function LoadingSliderSkeleton() {
  return (
    <div className="px-8 container xlg:max-w-none animate-pulse">
      <div className=" flex justify-evenly border dark:bg-dark dark:border-none border-stroke-gray rounded-20 p-4 overflow-hidden  mx-auto gap-6">
        <CardSkeleton />
