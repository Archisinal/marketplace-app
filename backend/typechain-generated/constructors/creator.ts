...
import { ContractFile } from '../contract-info/creator';
...
export default class Constructors {
	...
	*/
   	async "defaultConstructor" (
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["defaultConstructor"]!({ gasLimit, storageDepositLimit, value: __options?.value }, );
			let response;
	...
	*/
   	async "newWithData" (
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["newWithData"]!({ gasLimit, storageDepositLimit, value: __options?.value }, owner, data);
			let response;
